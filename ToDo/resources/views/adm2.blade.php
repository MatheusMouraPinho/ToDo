...
<div class="container my-4">
    ...
    <br>
    <div class="row justify-content-center"><h3>Nível de acesso Usuários</h3></div><br>
    <div class="row justify-content-center">
        <form class="form-inline my-2 my-lg-0" method="POST" action="{{url('pesquisa_user')}}">
            ...
            <input class="form-control mr-sm-2" type="text" name="pesquisa_user" placeholder="Procure o usuário pelo Nome ou RGM/CPF" aria-label="Search" style="width: 250px">
