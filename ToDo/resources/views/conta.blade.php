                ...
                @if(is_null($dados['telefone']))
                  <div class="dados-pessoais">
                    <p style="padding: 5px; margin: 0px;">
                      ...
                      Telefone/Celular: <span class="font-italic">Não definido</span>
                    </p>
                  </div>
                @else 
                  <div class="dados-pessoais">
                    <p id="telefone" style="padding: 5px; margin: 0px;">
                      ...
                      Telefone/Celular: {{ $dados['telefone'] }}
                    </p>
                  </div>
                @endif
                ...
                @if(empty($dados['instituicao'][0]))
                  <div class="dados-pessoais">
                    <p style="padding: 5px; margin: 0px;">
                      ...
                      Instituição de Ensino: <span class="font-italic">Não definido</span>
                    </p>
                  </div>
                @else 
                  <div class="dados-pessoais">
                ...
                @if(empty($dados['area'][0]))
                  <div class="dados-pessoais">
                    <p style="padding: 5px; margin: 0px;">
                      ...
                      Área: <span class="font-italic">Não definido</span>
                    </p>
                  </div>
                @else 
                  <div class="dados-pessoais">
                ...
                @if(empty($dados['cidade'][0]))
                  <div class="dados-pessoais">
                    <p style="padding: 5px; margin: 0px;">
                      ...
                      Região: <span class="font-italic">Não definido</span>
                    </p>
                  </div>
                @else 
                  <div class="dados-pessoais">
                    <p style="padding: 5px; margin: 0px;">
                      ...
                      Região: {{ $dados['cidade'] }} - {{ $dados['uf'][0]->uf_regiao_estado }}
                    </p> 
                  </div> 
                @endif             
                      ...
                      <td>
                        ...
                        <div class="btn-group dropdown">
                          ...
                          <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="" data-toggle="modal" data-target="#del-post{{$dados['id']}}">
