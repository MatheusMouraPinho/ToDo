...
<?php while($rows = mysqli_fetch_assoc($result2)){?>
    ...
    <!-- Modal deletar notifi -->
    <div class="modal fade id" id="del-notifi<?php echo $rows['id_notificacao'];?>" role="dialog">
    ...
    <!-- FIM Modal deletar notifi -->
<?php } ?>
<?php if($total_pesquisa == 0){ ?>
    <div class="aviso-home" style="margin-top:80px;margin-bottom:80px;">    
        <img class="aviso-img" src="{{asset('img/danger.png')}}">
        <div class="aviso-text"><b>Nenhuma notificação encontrada</b></div>
    </div>
<?php } ?>
