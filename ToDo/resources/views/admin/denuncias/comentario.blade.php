...
<div class="d-flex admin" id="wrapper">
    ...
    <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
            <button class="btn btn-edit btn-primary" id="menu-toggle">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            ...
                                            <form action="{{url('alterar')}}" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <br>
                                                    <div class="container">
                                                        <textarea class="form-control textarea-modal" style="background-color:white;box-shadow: 1px 1px 5px #999;" rows="6" readonly><?php echo $rows['conteudo_comentarios'] ?></textarea>
                                                    </div>
                                                </div>
