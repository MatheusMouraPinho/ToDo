...
--
-- Estrutura da tabela `check_denuncia`
--
...
--
-- Estrutura da tabela `check_denuncia_comentarios`
--
...
INSERT INTO `motivo_denuncia` (`id_motivo_denuncia`, `nome_motivo`) VALUES
(1, 'Spam'),
(2, 'Copia'),
...
--
-- Estrutura da tabela `status_solicitacoes`
--
...
--
-- Extraindo dados da tabela `status_solicitacoes`
--

INSERT INTO `status_solicitacoes` (`id_status`, `nome_status`) VALUES
(1, 'Aprovada'),
(2, 'Recusada'),
(3, 'Pendente');
...
--
-- Estrutura da tabela `tipo_solicitacoes`
--
...
--
-- Índices para tabela `check_denuncia`
--
...
--
-- Índices para tabela `check_denuncia_comentarios`
--
...
ALTER TABLE `motivo_denuncia`
  ADD PRIMARY KEY (`id_motivo_denuncia`);
...
ALTER TABLE `solicitacoes`
  ...
  ADD KEY `usuario_solicitacao` (`usuario_solicitacao`),
  ADD KEY `status_solicitacao` (`status_solicitacao`);

--
-- Índices para tabela `status_solicitacoes`
--
ALTER TABLE `status_solicitacoes`
  ADD PRIMARY KEY (`id_status`);

--
-- Índices para tabela `tipo_solicitacoes`
--
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `id_regiao_estado` (`id_regiao_estado`);
...
--
-- Limitadores para a tabela `check_denuncia`
--
ALTER TABLE `check_denuncia`
  ADD CONSTRAINT `check_denuncia_ibfk_1` FOREIGN KEY (`id_postagem`) REFERENCES `postagens` (`id_postagem`),
  ADD CONSTRAINT `check_denuncia_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);

--
-- Limitadores para a tabela `check_denuncia_comentarios`
--
ALTER TABLE `check_denuncia_comentarios`
  ADD CONSTRAINT `check_denuncia_comentarios_ibfk_1` FOREIGN KEY (`id_comentario`) REFERENCES `comentarios` (`id_comentarios`),
  ADD CONSTRAINT `check_denuncia_comentarios_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);
...
ALTER TABLE `denuncias`
  ...
  ADD CONSTRAINT `denuncias_ibfk_2` FOREIGN KEY (`id_motivo`) REFERENCES `motivo_denuncia` (`id_motivo_denuncia`);
...
ALTER TABLE `denuncias_comentarios`
  ...
  ADD CONSTRAINT `denuncias_comentarios_ibfk_3` FOREIGN KEY (`id_motivo`) REFERENCES `motivo_denuncia` (`id_motivo_denuncia`);
...
--
ALTER TABLE `solicitacoes`
  ADD CONSTRAINT `solicitacoes_ibfk_1` FOREIGN KEY (`tipo_solicitacao`) REFERENCES `tipo_solicitacoes` (`id_tipo_solicitacao`),
  ADD CONSTRAINT `solicitacoes_ibfk_2` FOREIGN KEY (`usuario_solicitacao`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `solicitacoes_ibfk_3` FOREIGN KEY (`status_solicitacao`) REFERENCES `status_solicitacoes` (`id_status`);
...
ALTER TABLE `usuarios`
  ...
  ADD CONSTRAINT `usuarios_ibfk_7` FOREIGN KEY (`id_regiao_estado`) REFERENCES `regiao_estado` (`id_regiao_estado`);
COMMIT;
