      ...
      <div id="area_principal">
        ...
        <div id="area-dados">
            <div class="card-body text-center">
              ...
              @if($dados['img'] === null)
                <img width="150px" src="{{asset('img/semuser.png')}}">
              @else
                              ...
                              <div class="popup_aval">
                                ...
                                @if(!empty($post['avaliacao'][0]))
                                  @for($c=0; $c<sizeof($post['avaliacao']); $c++)
                                    ...
                                    <? $id_postagem = $post['avaliacao'][$c]->id_postagem; $id_postagem2 = $posts->id_postagem;?>
                                      <p class="popup_avali">
                                ...
                                {{-- <p class="popup_avali">{{$dados['situacao'][$i]->situacao_postagem}}</p> --}}
                              </div>
                ...
                <form action="{{route('profile.update')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="popup-title">
                      ...
                      <a href="{{ url('/password/reset') }}" class="password">Esqueci minha senha</a>
                    </div>

                    <div class="popup-title">
                      <label for="telefone_usuario" class="bold subdados">Telefone</label>
                      <input type="text" class="btn-popup mr-sm-2" value="{{ $dados['telefone'] }}" name="telefone_usuario" placeholder="Ex: (11) 11111-1111">
                    </div>
                    ...
                    <div class="popup-title">
                      ...
                      {{-- <input type="text" value="{{ $dados['area'] }}" name="area" placeholder="Área"> --}}
                    ...
                    <div class="popup-title">
                      ...
                      {{-- <input type="text" value="{{ $dados['cidade'] }}" name="instituicao" placeholder="Instituicao de Ensino"> --}}
